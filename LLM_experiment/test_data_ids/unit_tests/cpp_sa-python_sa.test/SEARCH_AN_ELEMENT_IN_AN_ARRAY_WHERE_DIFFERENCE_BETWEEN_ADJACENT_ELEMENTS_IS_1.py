...
def f_filled ( arr , n , x ): i = 0 ; while i < n : if arr [ i ] == x : return i ; i += abs ( arr [ i ] - x ) ; NEWLINE i -= 1 #correcttheloopconditioninPythonNEWLINEifi>=n:print("numberisnotpresent!");return-1;DEDENT
