...
def f_filled\_query(a, n, l, r): return sum(map(lambda x, y: int(x == y), a[l:r])) #NEWLINE#INDENTdefmain():int\_list=[1,2,2,3,3,3,4,4,4]#NEWLINEprint(f_filled\_query(int\_list,len(int\_
