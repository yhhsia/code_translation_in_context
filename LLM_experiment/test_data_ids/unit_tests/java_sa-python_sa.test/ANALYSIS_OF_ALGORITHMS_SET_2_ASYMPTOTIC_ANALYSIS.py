...
def f_filled ( arr , n , x ): i = 0 while i < n: if arr [ i ] == x: return i
i += 1 DEDENT #endofwhileloopDEDENT#endoffunction#Note:Pythondoesnotsupportpassingarraysasargumentsdirectly.Here,weassume'arr'isalist.
