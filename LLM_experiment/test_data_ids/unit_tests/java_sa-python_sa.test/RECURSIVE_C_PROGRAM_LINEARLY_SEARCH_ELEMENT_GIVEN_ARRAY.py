...
def f_filled ( arr , l , r , x : int ) :IF l > r : return - 1IF arr [ l ] == x : return lIF arr [ r ] == x : return rreturn f_filled ( arr , l + 1 , r - 1 , x )
#ENDOFCODE#ThisisthePythonequivalentofthegivenC++code.#NotethatPythondoes
